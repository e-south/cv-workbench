...
--------------------------------------------------------------------------------
cv-workbench
cv-workbench/src/cvworkbench/registry.py
...
from cvworkbench.ingest import ExtractResult, IngestError, fetch_and_extract
from cvworkbench.signals import build_signals
from cvworkbench.strategy import build_strategy
